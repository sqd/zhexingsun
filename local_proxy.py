...
PROXY_SERVER_ADDRESS = 'localhost'
PROXY_SERVER_SECRET_HEADER = 'X-Proxy-Secret'
PROXY_SERVER_SECRET_KEY = '1234'
...
class ProxyRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            headers[PROXY_SERVER_SECRET_HEADER] = PROXY_SERVER_SECRET_KEY
            headers[PROXY_SERVER_SCHEME_HEADER] = scheme

            conn = httplib.HTTPSConnection(PROXY_SERVER_ADDRESS, timeout=self.timeout,
                                           context=ssl._create_unverified_context() if PROXY_SELF_SIGNED else None)
